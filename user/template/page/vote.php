                                  ...
                                  if($date_p >= $batas)
                                  {
                                    ...
                                    }elseif($status['status_memilih'] == "Sudah")
                                    {
                                      ?>
                                        ...
                                        <form action="../proses/cetak/suara.php" method="post">
                                        <button class="btn mt-2 btn-block btn-primary"><em class="fas fa-eye"></em> Lihat Hasil Kandidat Sementara</button>
                                        </form>
                                      <?php
                                    }
                                  }
