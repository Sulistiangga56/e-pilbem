<?php
  ...
  $spreadsheet->getProperties()->setCreator('U-Choice')
  ->setLastModifiedBy('Aplication U-Choice')
  ->setTitle('U-Choice Data Mahasiswa')
  ->setSubject('Data Mahasiswa')
  ->setDescription('Data Mahasiswa U-Choice')
  ->setKeywords('Mhs')
