<?php
    ...
    if(isset($_POST['login']))
    {
        ...
        if($cek > 0)
        {
            ...
            $_SESSION['val'] = "<div id='auto-close' class='alert alert-success bg-success text-white'><em class='fas fa-check-circle'></em> Selamat Datang $data[nama] Di Aplikasi U-CHOICE Anda Login Sebagai $data[level]</div>";
            header('location: ../');
        }
