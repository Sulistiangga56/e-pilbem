    ...
    <div class="nav-list">
        <div class="pcoded-inner-navbar main-menu">
            ...
            <ul class="pcoded-item pcoded-left-item">
                ...
                <li class="">
                    <a onclick="javascript:window.location.href='?page=account'" class="waves-effect waves-dark" style="display: ">
                ...
                <li class="pcoded-hasmenu">
                    ...
                    <ul class="pcoded-submenu">
                        <li class="">
                            <a onclick="javascript:window.location.href='?page=data_kelas'" class="waves-effect waves-dark" style="display: ">
                                <span class="pcoded-mtext">Data Kelas</span>
                            </a>
                        </li>
                        <li class="">
                            <a onclick="javascript:window.location.href='?page=data_mahasiswa'" class="waves-effect waves-dark" style="display: ">
                                <span class="pcoded-mtext">Data Mahasiswa</span>
                            </a>
                        </li>
                        <li class="">
                            <a onclick="javascript:window.location.href='?page=data_dtk'" class="waves-effect waves-dark" style="display: ">
                                <span class="pcoded-mtext">Data DTK</span>
                            </a>
                        </li>
                        <li class="">
                            <a onclick="javascript:window.location.href='?page=data_kandidat'" class="waves-effect waves-dark" style="display: ">
